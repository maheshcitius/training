...
export const ManagePatientView = (props) =>{
    ...
    const { address, ethnicity, familyMedicalHistory, gender, insuranceProvideer, medicalHistory, occupation, patientId, surgeries} =patientReducer.patientDemographics[0];
    const patientImmunisation =patientReducer.patientImmunisation;


    console.log("-----state value patientReducer------",patientReducer);
    console.log("-----props.data------",props.data);
    const {firstName, lastName, dateOfBirth, email, mobileNumber} =props.data;
    ...
    return ( 
        ...
        <Stack spacing={3}>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3}>
            <TextField
                ...
                defaultValue={insuranceProvideer}
                InputProps={{
                    readOnly: true,
                }}
                variant="standard"
            ...
            <TextField
                ...
                defaultValue={familyMedicalHistory}
                InputProps={{
                    readOnly: true,
                }}
                variant="standard"
        ...
        <Typography sx={{ fontSize: 14, padding:"15px 0 0 0"}} variant="h6" color="text.secondary" gutterBottom>
