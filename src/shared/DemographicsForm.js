...
export const DemographicsForm = (props) => {
  ...
  const [isExist, setisExist] = React.useState(0);
  ...
  React.useEffect(() => {
    ...
    if (props.savedValues.length > 0) {
      setisExist(props.savedValues[0].id);
    }
    setsaved({
        ...
        render={({
          ...
          >
            ...
            <TextField
              ...
              onChange={formik.handleChange}
              error={
                formik.touched.ethinicity && Boolean(formik.errors.ethinicity)
              }
            ...
            <TextField
              ...
              onChange={formik.handleChange}
              error={
                formik.touched.employment && Boolean(formik.errors.employment)
              }
            ...
            <TextField
              ...
              onChange={formik.handleChange}
              error={
                formik.touched.surgeries && Boolean(formik.errors.surgeries)
              }
