...
export const GetMedications = (props)=>{
  ...
  const [otherAllergies,setOtherAllergies] = useState(MedicationInfo.otherAllergies);
  const [hvma,setHvma] =useState(MedicationInfo.HVMA);
  const [drugAllergies,setDrugAllergies]  =useState(MedicationInfo.drugAllergies);
  const [socialDrugs,setSocialDrugs]  = useState(MedicationInfo.socialDrugs);

  const allvalues = {currentMedication,otherAllergies,hvma,drugAllergies,socialDrugs}
    ...
    {console.log(currentMedication,"meee")}
       <FormField name = "Current Medication" >
        ...
        >
         ...
         { currentMedication && currentMedication.map((d,i)=>
           <MenuItem  onSelect = {()=>console.log(d)} key ={i} value={d} name= {d.drugName}>
        ...
        <TextField 
          ...
          variant="filled" 
          value={medicationDetail != "" && `${medicationDetail.type} medication by ${medicationDetail.prescribeBy} ${medicationDetail.directions} ` }
