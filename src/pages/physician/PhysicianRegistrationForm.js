  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
         <form>
             <TextField id="firstName" value={firstName} onChange={e=>onChange(e)} placeholder="Enter name" label="firstName" variant="outlined" margin="dense" fullWidth />
             <TextField id="lastName" value={lastName} onChange={e=>onChange(e)} placeholder="Enter email" label="lastName" variant="outlined" margin="dense" fullWidth />
