...
export const PhysicianProfile = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      speciality: physicians.speciality,
      ...
      <Container maxWidth="xl">
        <Box sl={{ pb: 5 }}>
          <Typography variant="h4">
            Hi, Welcome {physicians.firstname}, {physicians.lastname}{" "}
          </Typography>
          <Box
            component="form"
          ...
          >
            <Card sx={{ minWidth: 275 }}>
              <CardContent>
                ...
                <InputLabel id="labelrole">speciality</InputLabel>
                <Select
                  id="speciality"
                  name="speciality"
                  margin="normal"
                ...
                >
                  <MenuItem value={"Immunologists"} name="speciality">
                    Immunologists
                  </MenuItem>
                  <MenuItem value={"Cardiologists"} name="speciality">
                    Cardiologists
                  </MenuItem>
                  <MenuItem value={"Dermatologists"} name="speciality">
                    Dermatologists
                  </MenuItem>
                  <MenuItem value={"Neurologists"} name="speciality">
                    Neurologists
                  </MenuItem>
                </Select>
                <TextField
