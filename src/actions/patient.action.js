...
function getAllPatients() {
  ...
  return (dispatch) => {
    ...
    patientService.getAllPatients().then(
        ...
        if (patients) {
          dispatch(
            snackbarActions.toggleSnackbarOpen({
              message: "Patients data loaded Successful..!",
              type: "success",
            })
          );
      ...
      (error) => {
        ...
        dispatch(
          snackbarActions.toggleSnackbarOpen({
            message: "Patients data Failed to load",
            type: "warning",
          })
        );
      }
  ...
  function request() {
    return { type: patientConstants.GETALL_PATIENT_REQUEST };
  }
  function success(patients) {
    return { type: patientConstants.GETALL_PATIENT_SUCCESS, patients };
  }
  function failure(error) {
    return { type: patientConstants.GETALL_PATIENT_FAILURE, error };
  }
}
...
function deletePatientById(id) {
  ...
  return (dispatch) => {
    dispatch(request());
    console.log("before call service");
    patientService.deletePatientByIdService(id).then(
      (patient) => {
        if (patient) {
          dispatch(
            toggleSnackbarOpen({
              message: "Patient data deleted Successfuly..!",
              type: "success",
            })
          );
...
function updatePatient(id, updatePayload) {
  ...
  function success(payload) {
    return { type: patientConstants.UPDATE_PATIENT_SUCCESS, payload };
  }
  function failure(payload) {
    return { type: patientConstants.UPDATE_PATIENT_FAILURE, payload };
  }
}
...
function getPatientDemographicsDetails(patientId) {
  ...
  function success(payload) {
    return { type: patientConstants.PATIENT_DEMOGRAPHICS_SUCCESS, payload };
  }
  function failure(payload) {
    return { type: patientConstants.PATIENT_DEMOGRAPHICS_FAILURE, payload };
  }
}
...
function getPatientImmunizationDetails(patientId) {
  ...
  return (dispatch) => {
    ...
    patientService
      .getPatientImmunization(patientId)
      .then((response) => {
  ...
  function request() {
    return { type: patientConstants.PATIENT_IMMUNISATION_REQUEST };
  }
  function success(payload) {
    return { type: patientConstants.PATIENT_IMMUNISATION_SUCCESS, payload };
  }
  function failure(payload) {
    return { type: patientConstants.PATIENT_IMMUNISATION_FAILURE, payload };
  }
}
