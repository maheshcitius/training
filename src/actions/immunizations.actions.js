...
function postImmunization(payload) {
    ...
    function request() { return { type: immunizationConstants.POST_IMMUNIZATION_REQUEST} }
    function success(immunization) { return { type: immunizationConstants.POST_IMMUNIZATION_SUCCESS, immunization } }
    function failure(error) { return { type: immunizationConstants.POST_IMMUNIZATION_FAILURE, error } }
}