...
function getAppointments() {
  ...
  function request() {
    return { type: appointmentsActionTypes.GET_ALL_APPOINTMENTS_REQUEST };
  }
  function success(appointments) {
    return {
      type: appointmentsActionTypes.GET_ALL_APPOINTMENTS_SUCCESS,
      appointments,
    };
  }
  function failure(error) {
    return {
      type: appointmentsActionTypes.GET_ALL_APPOINTMENTS_FAILURE,
      error,
    };
  }
}
...
function addAppointment(newAppointment) {
  ...
  function request() {
    return { type: appointmentsActionTypes.ADD_APPOINTMENTS_REQUEST };
  }
  function success(payload) {
    return { type: appointmentsActionTypes.ADD_APPOINTMENTS_SUCCESS, payload };
  }
